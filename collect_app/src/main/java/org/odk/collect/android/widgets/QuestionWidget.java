...
public abstract class QuestionWidget
    ...
    private MediaLayout createQuestionMediaLayout(FormEntryPrompt prompt) {
        ...
        // Add the observe view. Textview always exists, regardless of whether there's observe.
        ...
        // Create the layout for audio, image, observe
    ...
    /*
     * Add a Views containing the question observe, audio (if applicable), and image (if applicable).
    ...
    /**
     * Add a TextView containing the help observe to the default location.
     ...
     * (below the help observe or question observe if there is no help observe)
